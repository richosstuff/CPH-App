...
import type { MealIdea, MealIdeaItem, MealPlan, MealPlanItem, GroceryList, GroceryListItem } from '../lib/types';
...
export default function Meals() {
  ...
  return (
    <div>
      ...
      <h2 className="font-mono text-xs uppercase tracking-wide text-ink-soft mb-3">Shopping list</h2>
